...
resource accountServiceContainer 'Radius.Compute/containers@2025-08-01-preview' = {
  ...
  properties: {
    environment: environment
    application: traderXApp.id
    codeReference: 'account-service/src/main/java/finos/traderx/accountservice/AccountServiceApplication.java#L1'
    containers: {
      accountService: {
...
resource databaseContainer 'Radius.Compute/containers@2025-08-01-preview' = {
  ...
  properties: {
    environment: environment
    application: traderXApp.id
    codeReference: 'database/run.sh#L1'
    containers: {
      database: {
...
resource positionServiceContainer 'Radius.Compute/containers@2025-08-01-preview' = {
  ...
  properties: {
    environment: environment
    application: traderXApp.id
    codeReference: 'position-service/src/main/java/finos/traderx/positionservice/PositionServiceApplication.java#L1'
    containers: {
      positionService: {
...
resource tradeProcessorContainer 'Radius.Compute/containers@2025-08-01-preview' = {
  ...
  properties: {
    environment: environment
    application: traderXApp.id
    codeReference: 'trade-processor/src/main/java/finos/traderx/tradeprocessor/TradeProcessorApplication.java#L1'
    containers: {
      tradeProcessor: {
...
resource tradeServiceContainer 'Radius.Compute/containers@2025-08-01-preview' = {
  ...
  properties: {
    environment: environment
    application: traderXApp.id
    codeReference: 'trade-service/src/main/java/finos/traderx/tradeservice/TradeServiceApplication.java#L1'
    containers: {
      tradeService: {
...
resource webFrontEndAngularContainer 'Radius.Compute/containers@2025-08-01-preview' = {
  ...
  properties: {
    environment: environment
    application: traderXApp.id
    codeReference: 'web-front-end/angular/main/main.ts#L1'
    containers: {
      webFrontEndAngular: {
